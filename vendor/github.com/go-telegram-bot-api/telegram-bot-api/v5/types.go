...
type Update struct {
	...
	BusinnesMessage *Message `json:"business_message,omitempty"`
	EditedBusinnesMessage *Message `json:"edited_business_message,omitempty"`
	DeletedBusinnesMessage *Message `json:"deleted_business_messages,omitempty"`
...
type Message struct {
	DeletedMessagesIds []int `json:"message_ids,omitempty"`
